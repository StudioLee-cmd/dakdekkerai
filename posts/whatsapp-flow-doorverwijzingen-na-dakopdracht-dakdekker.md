---
title: "WhatsApp-flow voor doorverwijzingen na dakopdracht"
slug: whatsapp-flow-doorverwijzingen-na-dakopdracht-dakdekker
date: "2026-05-15"
excerpt: "Vraag systematisch om doorverwijzingen via WhatsApp na elke dakopdracht. 3 momenten, 4 scripts en CRM-tracking voor 5+ extra leads per maand."
...
## De 3 momenten waarop je vraagt

Niet één keer vragen, niet vijf keer vragen. Drie keer, op specifieke momenten met specifieke vragen.

### Moment 1: 24 uur na oplevering (foto plus dankbericht)
...
Een week later, op een werkdag tussen 9:00 en 11:00, stuur je het tweede bericht. Hier vraag je twee dingen tegelijk in één compact bericht: een Google review én of ze iemand kennen in de buurt met een soortgelijk dakprobleem.
...
## De 4 berichten-scripts die werken

Hieronder de exacte berichten die je via WhatsApp Business inplant. Pas namen en buurtnamen aan.

### Script 1: 24-uurs dankbericht (geen vraag)
...
Als iemand antwoordt met "ja, mijn buurman [naam] heeft een lekkend dak", stuur direct:
...
- **Doorverwezen leads:** namen plus contactgegevens
- **Reward owed:** open of betaald (cadeaubon, korting volgende klus, of niks afhankelijk van jouw beleid)

Een [crm voor dakdekkers](/crm) met deze 4 velden per klant maakt dat je iedere week ziet welke klanten klaar zijn voor moment 2 of moment 3, zonder dat je het zelf hoeft bij te houden. Dat is het verschil tussen "ik vraag soms" en "ik vraag systematisch."
...
**Fout 3: Geen opvolging op replies.** Klant antwoordt met "ja, mijn buurman zou een check waarderen", en jij reageert pas 3 dagen later (of helemaal niet). De buurman is dan al verder gezocht. Een [chatbot voor dakdekkers](/chatbot) gekoppeld aan WhatsApp Business vangt eerste reacties automatisch op en stuurt jou een melding voor de telefonische follow-up.

## Wat het oplevert in cijfers

Voor een gemiddelde dakdekker met 8 opleveringen per week (32 per maand):

- 32 klanten krijgen Script 1 (dankbericht). 22 reageren positief.
- 32 klanten krijgen Script 2 (review-plus-doorverwijzing) na 7 dagen. 13 reageren. 4 geven een doorverwijzing (12,5 procent conversie).
- 32 klanten krijgen Script 3 (seizoens-trigger) na 90 dagen. 6 reageren. 2 geven een doorverwijzing.

Totaal per maand: 6 doorverwijzingen, omgezet naar 4 tot 5 daadwerkelijke offertes, omgezet naar 2 tot 3 nieuwe opdrachten. Bij een gemiddelde dakopdracht-waarde van 4.200 euro is dat 8.400 tot 12.600 euro extra omzet per maand uit puur WhatsApp-doorverwijzingen.

Op jaarbasis: 24 tot 36 extra opdrachten, 100.000 tot 150.000 euro extra omzet zonder advertentiebudget.

## Hoe je dit binnen 2 weken live krijgt

Drie stappen, samen 4 tot 6 uur werk verspreid over 2 weken:

**Week 1, dag 1-2 (1 uur werk):** WhatsApp Business installeren op je werktelefoon (gratis), de 4 berichtensjablonen invoeren onder Snelle antwoorden (Quick Replies). Tijd: 45 minuten.

**Week 1, dag 3-5 (1 uur werk):** [crm voor dakdekkers](/crm) opzetten met de 4 tracking-velden per klant. Bestaande klanten van de afgelopen 90 dagen invoeren. Tijd: 1 uur.

**Week 2 (continue):** Bij elke oplevering moment 1 sturen. Voor klanten van vóór de CRM-start moment 2 of 3 inhalen waar het natuurlijk past. Na 30 dagen evalueren welke scripts de hoogste reply-rate geven en welke je aanpast.

## Wat StudioLee voor je inricht

Bij DakdekkerAI helpen we dakdekkers hun referral-flow professioneel inrichten met WhatsApp + CRM + AI als basis. Concreet wat we inrichten:

- WhatsApp Business installatie op je werktelefoon plus de 4 berichten-templates met jouw bedrijfsnaam en branding
- Een [crm voor dakdekkers](/crm) met automatische 24u/7d/90d triggers per opgeleverde klus
- Een [chatbot voor dakdekkers](/chatbot) die binnenkomende WhatsApp-replies 24/7 opvangt en jou meldt voor follow-up
- Een [voice ai voor dakdekkers](/voice-ai) die warme doorverwijzingen kan opbellen wanneer jij geen tijd hebt
- Een review-tracking dashboard dat per klant ziet wie heeft beoordeeld én doorverwezen
