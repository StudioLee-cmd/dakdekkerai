...
const niche = siteDetails.niche?.toLowerCase() || "dakdekkers";
...
const workflows = [
  ...
  },
  {
    ...
    desc: `Klantspecifieke onderhoud- of opvolg-cycli automatisch beheerd. Voor Dakdekkers: weersvoorspelling-check bij geplande dakwerken, automatische storm-schade-opvolging na lokale weer-alerts, jaaronderhoud-herinnering voor klanten met vorige reparaties — terugkerende omzet zonder dat jij eraan hoeft te denken.`,
  },
];
...
const integrations = [
  { icon: BsWhatsapp, title: "WhatsApp Business", desc: "Het hoofdkanaal — 90% van dakdekkers-klanten checkt WhatsApp sneller dan e-mail." },
      ...
      <section className="py-12 md:py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            maar wel volle agendas willen. Jij dekt het dak, wij regelen de rest.
          </motion.p>
          <motion.div
