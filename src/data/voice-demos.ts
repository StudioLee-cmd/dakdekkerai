...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een dakdekker met een lekkage belt buiten kantooruren; de agent vraagt door op spoed en plant een inspectie in.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een klant wil de geplande dakinspectie een week opschuiven vanwege het weer.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand wil weten wat een dakgoot vervangen kost en of er nog subsidie op zit.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
