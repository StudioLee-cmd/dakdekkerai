...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor dakdekkers" }, { href: "/chatbot", anchor: "ai chatbot voor dakdekkers" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor dakdekkers" }, { href: "/reviews", anchor: "review management voor dakdekkers" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor dakdekkers" }, { href: "/crm", anchor: "crm voor dakdekkers" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor dakdekkers" }],
    }
];
